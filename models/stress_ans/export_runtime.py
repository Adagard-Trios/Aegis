"""Export the latest trained stress_ans model as a runtime pickle.

See models/fetal_health/export_runtime.py for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/neurology/stress_ans/model.pkl
"""
...
RUNTIME_SUBPATH = "neurology/stress_ans/model.pkl"
