"""Export the latest trained skin_disease model as a runtime pickle.

See models/fetal_health/export_runtime.py for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/dermatology/skin_disease/model.pkl
"""
...
RUNTIME_SUBPATH = "dermatology/skin_disease/model.pkl"
