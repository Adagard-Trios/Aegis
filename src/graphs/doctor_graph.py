...
builder.add_node("psychiatric_expert", psychiatric_expert)
...
builder.add_node("environment_context_expert", environment_context_expert)
builder.add_node("occulometric_expert", occulometric_expert)
builder.add_node("infectious_disease_expert", infectious_disease_expert)
