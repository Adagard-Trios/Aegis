"""retinal_age — ModelTrainer

Source notebook: notebooks/source.ipynb
Notebook architecture: RETFound MAE ViT-Large encoder + MSE regression head (1024->256->1).

This pipeline currently trains on the ODIR metadata (sex, age target, image_path) features produced by
