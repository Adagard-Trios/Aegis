"""Export the latest trained ecg_arrhythmia model as a runtime pickle.

See models/fetal_health/export_runtime.py for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/cardiology/ecg_arrhythmia/model.pkl
"""
...
RUNTIME_SUBPATH = "cardiology/ecg_arrhythmia/model.pkl"
