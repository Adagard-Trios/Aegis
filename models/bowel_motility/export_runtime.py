"""Export the latest trained bowel_motility model as a runtime pickle.

See models/fetal_health/export_runtime.py for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/general_physician/bowel_motility/model.pkl
"""
...
RUNTIME_SUBPATH = "general_physician/bowel_motility/model.pkl"
