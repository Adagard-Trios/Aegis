"""Export the latest trained lung_sound model as a runtime pickle.

See models/fetal_health/export_runtime.py for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/pulmonary/lung_sound/model.pkl
"""
...
RUNTIME_SUBPATH = "pulmonary/lung_sound/model.pkl"
