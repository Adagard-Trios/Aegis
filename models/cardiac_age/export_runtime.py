"""Export the latest trained cardiac_age model as a runtime pickle.

See models/fetal_health/export_runtime.py for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/cardiology/cardiac_age/model.pkl
"""
...
RUNTIME_SUBPATH = "cardiology/cardiac_age/model.pkl"
