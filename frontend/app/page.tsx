    ...
    >
      ...
      <motion.div style={{ opacity: vestOpacity, y: vestY }} className="absolute inset-0 pointer-events-none">
        <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
          ...
          <VestModel3D />
          <OrbitControls enableZoom={false} enablePan={false} autoRotate autoRotateSpeed={0.4} target={[0, 0.3, 0]} />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Canvas camera={{ position: [0, 0.4, 4.2], fov: 40 }}>
            ...
            <VestModel3D />
            <OrbitControls enableZoom={false} enablePan={false} autoRotate autoRotateSpeed={0.6} target={[0, 0.3, 0]} />
            <Environment preset="city" />
          </Canvas>
