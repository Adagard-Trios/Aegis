"""Export the latest trained parkinson_screener model as a runtime pickle.

See models/fetal_health/export_runtime.py for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/neurology/parkinson_screener/model.pkl
"""
...
RUNTIME_SUBPATH = "neurology/parkinson_screener/model.pkl"
