"""Export the latest trained retinal_disease model as a runtime pickle.

See `models/fetal_health/export_runtime.py` for the full design rationale.
Output: ${MEDVERSE_MODELS_DIR}/ocular/retinal_disease/model.pkl
"""
...
RUNTIME_SUBPATH = "ocular/retinal_disease/model.pkl"
