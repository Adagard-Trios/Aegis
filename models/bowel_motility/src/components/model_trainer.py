"""bowel_motility — ModelTrainer

Source notebook: notebooks/source.ipynb
Notebook architecture: LightGBM on 30 HRV features (n=300, num_leaves=40, lr=0.05, class_weight=balanced).

This pipeline currently trains on the synthetic 12 HRV-style features features produced by
DataIngestion._load_dataframe(). To upgrade to the notebook's full
architecture you'd extend `_load_dataframe` to return the raw long-window HRV from manometry
    ...
    def _build_model(self):
        try:
            ...
            return LGBMClassifier(
                n_estimators=300, num_leaves=40, learning_rate=0.05,
